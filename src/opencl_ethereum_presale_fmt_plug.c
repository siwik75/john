...
// };
struct fmt_tests opencl_ethereum_presale_tests[] = {
	{"$ethereum$w*1c361ac9c42af924f8697e9cd7c17f8136deb69a7fe02cfacbc47dff74737921c33b6b2dc3dbe6b7d3daa45dc979f084f1ce75b6cb38bba69b6e9a403c244641*c2ace478c476075f20bbfa77e22469abc7b8aa39*11111111111111111111111111111111", "5Cm2dXor0jrCHXPbctkr&/^-.5Cm2dXor0jrCHXPbctkr"},
	{NULL}
};
...
static cl_mem mem_in, mem_pbkdf2_out, mem_out, mem_salt, mem_state, mem_hash;
...
static void reset(struct db_main *db)
{
	if (!program[gpu_id]) {
		...
		opencl_init("$JOHN/opencl/ethereum_presale_kernel.cl",
		            gpu_id, build_opts);
